  ...
  return (
    <React.Fragment>
      <Dropdown isOpen={isCartDropdown} toggle={toggleCartDropdown} className="topbar-head-dropdown ms-1 header-item">
        ...
        <DropdownMenu className="dropdown-menu-xl dropdown-menu-end p-0" aria-labelledby="page-header-cart-dropdown">
              ...
              {cartData.map((item, key) => (
                <div className="d-block dropdown-item text-wrap dropdown-item-cart px-3 py-2" key={key}>
                  <div className="d-flex align-items-center">
                    <img src={item.img} className="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic" />
