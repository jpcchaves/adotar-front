  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(deleteProducts.fulfilled, (state: any, action: any) => {
      state.products = (state.products || []).filter(
        (product: any) => product.id.toString() !== action.payload.product.toString(),
      );
    });
    ...
    builder.addCase(deleteOrder.fulfilled, (state: any, action: any) => {
      state.orders = state.orders.filter((order: any) => order.id.toString() !== action.payload.order.toString());
    });
