...
const BasicTables = () => {
  document.title = "Basic Tables | adotar - React Admin & Dashboard Template";
                  ...
                  <div className="live-preview">
                    <div className="table-responsive">
                      <Table className="table-striped table-nowrap align-middle mb-0">
                        ...
                        <tbody>
                          <tr>
                            <td className="fw-semibold">01</td>
                            <td>Bobby Davis</td>
                            <td>Nov 14, 2021</td>
                            <td>$2,410</td>
                            <td>
                          ...
                          <tr>
                            <td className="fw-semibold">02</td>
                            <td>Christopher Neal</td>
                            <td>Nov 21, 2021</td>
                            <td>$1,450</td>
                            <td>
                          ...
                          <tr>
                            <td className="fw-semibold">03</td>
                            <td>Monkey Karry</td>
                            <td>Nov 24, 2021</td>
                            <td>$3,500</td>
                            <td>
                          ...
                          <tr>
                            <td className="fw-semibold">04</td>
                            <td>Aaron James</td>
                            <td>Nov 25, 2021</td>
                            <td>$6,875</td>
                            <td>
                    ...
                    <div className="table-responsive">
                      <Table className="table-sm table-nowrap mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td className="fw-semibold">05</td>
                            <td>Applications Engineer</td>
                            <td>
                              <span className="badge bg-success-subtle text-success">
                                Done
                          ...
                          <tr>
                            <td colSpan={5}>
                              <Table className="table-nowrap mb-0">
                                ...
                                <tbody>
                                  <tr>
                                    <td className="fw-semibold">I</td>
                                    <td>Milana Scot</td>
                                    <td>3d Animation</td>
                                    <td>James Black</td>
                                  </tr>
                                  <tr>
                                    <td className="fw-semibold">II</td>
                                    <td>Juston Eichmann</td>
                                    <td>Design syntax</td>
                                    <td>Olimpia Jordan</td>
                                  </tr>
