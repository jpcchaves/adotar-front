...
const FormWizard = () => {
  document.title = "Wizard | adotar - React Admin & Dashboard Template";

  const [activeTab, setactiveTab] = useState<number>(1);
  const [activeArrowTab, setactiveArrowTab] = useState(4);
  const [activeVerticalTab, setactiveVerticalTab] = useState(7);
  const [progressbarvalue, setprogressbarvalue] = useState<any>(0);
                      ...
                      <TabPane tabId={2}>
                        <div>
                          <div className="text-center">
                            ...
                            <h5 className="fs-15">Add Image</h5>
                          </div>
                          <div>
                            <Label
                              className="form-label"
                        ...
                        <ul className="list-group mb-3">
                          ...
                          <li className="list-group-item d-flex justify-content-between bg-light">
                            <div className="text-success">
                              ...
                              <span className="fs-12">−$5 Discount</span>
                            </div>
