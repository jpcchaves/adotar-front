...
const FormSelect = () => {
  document.title = "Form Select | adotar - React Admin & Dashboard Template";
              ...
              <Card>
                ...
                <CardBody>
                  <div>
                    ...
                    <div className="mt-4">
                      <h5 className="fs-15 mb-3">Multiple select input</h5>
                      <Row>
                        <Col lg={4} md={6}>
                          <div className="mb-3">
                            <Label
                    ...
                    <div className="mt-4">
                      {/* <h5 className="fs-15 mb-3">Text inputs</h5>
                                            <Row>
                                                <Col lg={4} md={6}>
                                                    <div className="mb-3">
