...
const CrmLeads = () => {
  ...
  const { leads, error } = useSelector(crmleadsProperties);
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        Cell: (cell: any) => (
          <>
            {cell.row.original.tags.map((item: any, key: any) => (
              <span
      ...
      },
      {
        ...
        accessor: "date",
        filterable: false,
        Cell: (cell: any) => <>{handleValidDate(cell.value)}</>,
      },
      {
        Header: "Action",
        Cell: (cellProps: any) => {
  ...
  document.title = "Leads | adotar - React Admin & Dashboard Template";
