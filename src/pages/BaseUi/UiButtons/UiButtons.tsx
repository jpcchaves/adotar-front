...
const UiButtons = () => {
  document.title = "Buttons | adotar - React Admin & Dashboard Template";
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code> btn</code> class to show the default button
                    style.
                  </p>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn-outline-</code> class with the below-mentioned
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <Button className="btn-soft-secondary waves-effect waves-light">
                        {" "}
                        Secondary{" "}
                      </Button>
                      <Button className="btn-soft-success waves-effect waves-light">
                        {" "}
                        Success{" "}
                      </Button>
                      <Button className="btn-soft-info waves-effect waves-light">
                        {" "}
                        Info{" "}
                      </Button>
                      <Button className="btn-soft-warning waves-effect waves-light">
                        {" "}
                        Warning{" "}
                      </Button>
                      <Button className="btn-soft-danger waves-effect waves-light">
                        {" "}
                        Danger{" "}
                      </Button>
                      <Button className="btn-soft-dark waves-effect waves-light">
                        {" "}
                        Dark{" "}
                      </Button>
                    </div>
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <Button
                        color="secondary"
                        className="btn btn-ghost-secondary waves-effect waves-light"
                      >
                        Secondary
                      </Button>
                      <Button
                      ...
                      <Button
                        color="info"
                        className="btn btn-ghost-info waves-effect waves-light"
                      >
                        Info
                      </Button>
                      <Button
                        color="warning"
                        className="btn btn-ghost-warning waves-effect waves-light"
                      >
                        Warning
                      </Button>
                      <Button
                      ...
                      <Button
                        color="dark"
                        className="btn btn-ghost-dark waves-effect waves-light"
                      >
                        Dark
                      </Button>
                    </div>
