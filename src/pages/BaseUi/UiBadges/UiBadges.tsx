...
const UiBadges = () => {
  document.title = "Badges | adotar - React Admin & Dashboard Template";
          ...
          <Row>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>bg-*-subtle text-*</code> class with the
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <span className="badge bg-light-subtle text-body text-body">
                        Light
                      </span>
                    </div>
                  </div>
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>border</code>, <code>border-*</code>{" "}
                    <code>text-*</code> class with the below-mentioned variation
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>rounded-pill bg-*-subtle text-*</code> class
                    with the below-mentioned variation to create a badge more
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <span className="badge rounded-pill bg-light-subtle text-body text-dark">
                        Light
                      </span>
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <code>bg-*-subtle text-*</code> with below mentioned
                    modifier classes to make badges with border & soft
                    background.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <span className="badge bg-light-subtle text-body badge-border text-dark">
                        Light
                      </span>
                    </div>
                  </div>
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>rounded-pill</code> <code>border</code>,{" "}
                    <code>border-*</code> <code>text-*</code> class with the
