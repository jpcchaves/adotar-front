...
const UiLink = () => {
  document.title = "Link | adotar - React Admin & Dashboard Template";
  return (
    <React.Fragment>
      <UiContent />
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    ...
                    <p>
                      <Link
                        to="#"
                        className="link-dark link-offset-2 text-decoration-underline link-underline-opacity-25 link-underline-opacity-100-hover"
                      >
                        Dark link
                      </Link>
                    </p>
