...
const UiMediaobject = () => {
  document.title = "Media object | adotar - React Admin & Dashboard Template";
                  ...
                  <div className="live-preview">
                    <div className="d-flex align-items-start text-muted mb-4">
                      ...
                      <div className="flex-grow-1">
                        <h5 className="fs-15">Media heading</h5>
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <div className="d-flex align-items-start text-muted mb-4">
                      ...
                      <div className="flex-grow-1">
                        <h5 className="fs-15">Top Aligned media</h5>
                        <p className="mb-1">
                    ...
                    <div className="d-flex align-items-center text-muted mb-4">
                      ...
                      <div className="flex-grow-1">
                        <h5 className="fs-15">Center Aligned media</h5>
                        <p className="mb-1">
                          Cras sit amet nibh libero, in gravida nulla. Nulla vel
                          metus scelerisque ante sollicitudin. Cras purus odio,
                          vestibulum in vulputate at, tempus viverra turpis.
                    ...
                    <div className="d-flex align-items-end text-muted">
                      ...
                      <div className="flex-grow-1">
                        <h5 className="fs-15">Bottom Aligned media</h5>
                        <p className="mb-1">
                          Cras sit amet nibh libero, in gravida nulla. Nulla vel
                          metus scelerisque ante sollicitudin. Cras purus odio,
                          vestibulum in vulputate at, tempus viverra turpis.
