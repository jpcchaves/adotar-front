...
const UiNotifications = () => {
  document.title = "Notifications | adotar - React Admin & Dashboard Template";
                          ...
                          <Toast isOpen={toast1}>
                            <ToastHeader toggle={() => setToast1(!toast1)}>
                              <img
                                ...
                                height="20"
                              />
                              <span className="fw-bold me-auto">adotar</span>
                        ...
                        <Toast isOpen={toast11}>
                          <ToastHeader toggle={() => setToast11(!toast11)}>
                            <img
                              ...
                              height="20"
                            />
                            <strong className="fw-bold me-auto">adotar</strong>
                            <small style={{ marginLeft: "150px" }}>
                              11 mins ago
                            </small>
                          </ToastHeader>
