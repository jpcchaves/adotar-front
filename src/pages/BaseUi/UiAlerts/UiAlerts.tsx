...
const UiAlerts = () => {
  ...
  document.title = "Alerts | adotar - React Admin & Dashboard Template";
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        <UncontrolledAlert
                          color="danger"
                          className="aalert alert-danger alert-dismissible bg-danger text-white alert-label-icon fade show mb-xl-0"
                          closeClassName="btn-close-white"
                        >
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>bg-*</code>, <code>border-*</code> &{" "}
                    <code>text-white</code> class to set an alert with solid
                    style.
                  </p>
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        <Alert
                          color="success"
                          className="alert bg-success border-success text-white"
                        >
                      ...
                      <Col xl={6}>
                        ...
                        <Alert
                          color="info"
                          className="alert bg-info border-info text-white"
                        >
                        ...
                        <Alert
                          color="light"
                          className="alert bg-light border-light text-body"
                        >
