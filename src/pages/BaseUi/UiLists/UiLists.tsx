...
const UiList = () => {
  document.title = "List | adotar - React Admin & Dashboard Template";
                      ...
                      >
                        ...
                        <div className="d-flex mb-2 align-items-center">
                          ...
                          <div className="flex-grow-1 ms-3">
                            <h5 className="list-title fs-16 mb-1">
                              Charlie Pritchard
                            </h5>
                            <p className="list-text mb-0 fs-13">12 min Ago</p>
                          </div>
                        </div>
                      ...
                      >
                        ...
                        <div className="d-flex mb-2 align-items-center">
                          ...
                          <div className="flex-grow-1 ms-3">
                            ...
                            <p className="list-text mb-0 fs-13">5 days Ago</p>
                          </div>
                        </div>
                        <p className="list-text mb-0">
