...
const UiTypography = () => {
  document.title = "Typography | adotar - React Admin & Dashboard Template";
                    ...
                    <Row>
                      <Col sm={6}>
                        <div className="text-muted">
                          ...
                          <div>
                            <p className="display-4 text-body fw-semibold">
                              Aa
                            </p>
                          </div>
                          <div>
                            <p className="mb-2">Font Family</p>
                            <h5 className="mb-0">'Nunito', sans-serif</h5>
                          </div>
                        </div>
                      </Col>
                      ...
                      <Col sm={6}>
                        <div className="text-muted mt-4 mt-sm-0">
                          ...
                          <div>
                            <h1 className="display-4 text-body fw-semibold">
                              Aa
                            </h1>
                          </div>
                          <div>
