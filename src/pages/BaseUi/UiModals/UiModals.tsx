...
const UiModals = () => {
  document.title = "Modals | adotar - React Admin & Dashboard Template";
  ...
  return (
    <React.Fragment>
      ...
      <Modal
        ...
        centered
      >
        <ModalHeader className="modal-title fw-bold">Center Modal</ModalHeader>
      ...
      >
        ...
        <div className="modal-footer">
          <div className="mx-auto">
            <Link to="#" className="btn btn-link fw-semibold">
              Read More{" "}
