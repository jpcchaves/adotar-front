...
const UiTabs = () => {
  document.title = "Tabs | adotar - React Admin & Dashboard Template";
  ...
  // Pills Tabs
  const [pillsTab, setpillsTab] = useState<any>("1");
  ...
  const [justifyPillsTab, setjustifyPillsTab] = useState<any>("1");
  ...
  // Header Justify Tabs
  const [headerJustifyTab, setheaderJustifyTab] = useState<any>("1");
  ...
  const [bottomCardTab, setbottomCardTab] = useState<any>("1");
  ...
  // Custom Hover Tabs
  const [customHoverTab, setcustomHoverTab] = useState<any>("1");
  ...
  const [customverticalTab, setcustomverticalTab] = useState<any>("1");
  ...
  const [animationNavTab, setanimationNavTab] = useState<any>("1");
  ...
  const [topBorderjustifyTab, settopBorderjustifyTab] = useState<any>("1");
  ...
  // Colored Nav
  const [colorNavTab, setcolorNavTab] = useState<any>("1");
  ...
  const [outlineBorderNav, setoutlineBorderNav] = useState<any>("1");
