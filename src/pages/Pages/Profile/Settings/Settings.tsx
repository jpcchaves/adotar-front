...
const Settings = () => {
  document.title =
    "Profile Settings | adotar - React Admin & Dashboard Template";
                          ...
                          <Col lg={6}>
                            <div className="mb-3">
                              ...
                              <Input
                                ...
                                defaultValue="daveadame@adotar.com"
                              />
                            </div>
                          </Col>
                          <Col lg={12}>
                              ...
                              <Col lg={12}>
                                <div className="mb-3">
                                  ...
                                  >
                                    ...
                                    number of fonts you use to three or less.
