...
const SimplePage = () => {
  document.title = "Profile | adotar - React Admin & Dashboard Template";
                          ...
                          <CardBody>
                            ...
                            <div className="d-flex mb-4">
                              ...
                              <div className="flex-grow-1 ms-3 overflow-hidden">
                                <Link to="#">
                                  <h6 className="text-truncate fs-15">
                              ...
                              <Col xs={6} md={4}>
                                <div className="d-flex mt-4">
                                  ...
                                  <div className="flex-grow-1 overflow-hidden">
                                    ...
                                    <Link to="#" className="fw-semibold fs-15">
                                      www.adotar.com
                                    </Link>
                                  </div>
                                </div>
                                          ...
                                          >
                                            <div className="accordion-body ms-2 ps-5">
                                              <p className="text-muted mb-2">
                                                ...
                                                adotar. Use the adotar to share
                        ...
                        <div className="acitivity-timeline">
                          ...
                          <div className="acitivity-item py-3 d-flex">
                            ...
                            <div className="flex-grow-1 ms-3">
                              ...
                              <p className="text-muted mb-2">
                                added a new member to adotar dashboard
                              </p>
