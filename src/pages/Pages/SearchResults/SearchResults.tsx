...
const SearchResults = () => {
  document.title = "Search Results | adotar - React Admin & Dashboard Template";
              ...
              <Card>
                <CardHeader className="border-0">
                  <Row className="justify-content-center mb-4">
                    ...
                    <Col lg={12}>
                      <h5 className="fs-16 fw-bold text-center mb-0">
                        Showing results for "
                  ...
                  <TabContent activeTab={activeTab} className="text-muted">
                    <TabPane tabId="1">
                      <div className="pb-3">
                        <h5 className="mb-1">
                          <Link to="#">
                            adotar - Responsive Bootstrap 5 Admin Dashboard
                          </Link>
                        </h5>
                        <p className="text-success mb-2">
                          https://themesbrand.com/adotar/index.html
                        </p>
                        <p className="text-muted mb-2">
                          adotar admin is super flexible, powerful, clean,
                          modern & responsive admin template based on{" "}
                          <span className="fw-bold">bootstrap 5</span> stable
                          with unlimited possibilities. You can simply change to
                          any layout or mode by changing a couple of lines of
                          code. You can start small and large projects or update
                          design in your existing project using adotar it is
                                ...
                                <div className="d-sm-flex">
                                  ...
                                  <div className="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                    <ul className="list-inline mb-2">
                                      <li className="list-inline-item">
                                        <span
                                          className={`badge bg-${item.badgeClass}-subtle text-${item.badgeClass} fs-12`}
                                        >
                                          {item.badgeText}
                                        </span>
                                      </li>
