...
const Pricing = () => {
  document.title = "Pricing | adotar - React Admin & Dashboard Template";
      ...
      <div className="page-content">
        <Container fluid>
                  ...
                  <CardBody className="bg-light m-2 p-4">
                    <div className="d-flex align-items-center mb-3">
                      <div className="flex-grow-1">
                        <h5 className="mb-0 fw-bold">{price1.type}</h5>
                      </div>
                    ...
                    <ul className="list-unstyled vstack gap-3">
                      ...
                      <li>
                        <div className="d-flex">
                          ...
                          <div className="flex-grow-1">
                            <b>{price1.storage}</b> {price1.storageb}
                          </div>
                        </div>
                      </li>
                      <li>
                    ...
                    <Card className="pricing-box ribbon-box right">
                      ...
                      <CardBody className="p-4 m-2">
                        <div className="d-flex align-items-center">
                          <div className="flex-grow-1">
                            <h5 className="mb-1 fw-bold">{price2.type}</h5>
                        ...
                        <div className="pt-4">
                          <h2>
                            ...
                            {price2.rate}
                            <span className="fs-14 text-muted">/Month</span>
                          </h2>
                        </div>
          ...
          <Row className="justify-content-center mt-5">
            <Col lg={4}>
              <div className="text-center mb-4 pb-2">
                <h4 className="fw-bold fs-22">Simple Pricing Plan</h4>
                <p className="text-muted mb-4 fs-15">
                  Simple pricing. No hidden fees. Advanced features for you
                  business.
                </p>
