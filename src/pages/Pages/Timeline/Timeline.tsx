...
const Timeline = () => {
  ...
  document.title = "Timeline | adotar - React Admin & Dashboard Template";
                ...
                <div className="timeline">
                  ...
                  <div className="timeline-item left">
                    ...
                    <div className="content">
                      ...
                      <p className="text-muted">
                        Every team project can have a adotar. Use the adotar to
                  ...
                  <div className="timeline-item left">
                    ...
                    <div className="content">
                      <h5>adotar admin dashboard templates layout upload</h5>
                      <p className="text-muted">
                  ...
                  <div className="timeline-continue">
                    ...
                    <Row className="timeline-right">
                      ...
                      <Col xs={12}>
                        <div className="timeline-box">
                          <div className="timeline-text">
                            <h5>adotar - Project Discussion</h5>
                            <p className="text-muted mb-0">
                      ...
                      <SwiperSlide>
                        <div className="card pt-2 border-0 item-box text-center">
                          <div className="timeline-content p-3 rounded">
                            <div>
                              <p className="text-muted mb-0">December, 2020</p>
