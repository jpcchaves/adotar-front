        ...
        () => [
            {
                ...
                Cell: (cellProps: any) => {
                    return <input type="checkbox" className="ticketCheckBox form-check-input" value={cellProps.row.original.id} onChange={() => deleteCheckbox()} />;
                },
                id: '#',
            },
            {
                        ...
                        <CardBody className='pt-0'>
                            {isTicketSuccess && ticketdata.length ? (
                                <TableContainer
                                    ...
                                    divClass="table-responsive table-card mb-3 mt-0"
