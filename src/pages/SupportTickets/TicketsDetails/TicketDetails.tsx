              ...
              <Table className="table-borderless align-middle mb-0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="hstack text-wrap gap-1 fs-15">
        ...
        <Card>
          ...
          <CardBody>
            <div className="d-flex align-items-center border border-dashed p-2 rounded">
              ...
              <div className="flex-grow-1 ms-3">
                <h6 className="mb-1 fs-15">
                  <Link to="#">adotar-admin.zip</Link>
                </h6>
                <span className="text-muted">3.2 MB</span>
              </div>
            ...
            <div className="d-flex  align-items-center border border-dashed p-2 rounded mt-2">
              ...
              <div className="flex-grow-1 ms-3">
                <h6 className="mb-1 fs-15">
                  <Link to="#">adotar-admin.ppt</Link>
                </h6>
                <span className="text-muted">4.5 MB</span>
              </div>
              <div className="hstack gap-3 fs-16">
                <Link to="#" className="text-muted">
                  <i className="ri-download-2-line"></i>
