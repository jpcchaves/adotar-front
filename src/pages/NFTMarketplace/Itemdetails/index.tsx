...
const ItemDetails = () => {
  document.title = "Item Details | adotar - React Admin & Dashboard Template";
                ...
                <Col lg={8}>
                  <div>
                    ...
                    <div className="mt-4 text-muted">
                      <h5 className="fs-14 fw-bold">Description :</h5>
                      <p>
                    ...
                    <div className="product-content mt-5">
                      <h5 className="fs-14 mb-3 fw-bold">
                        Product Description :
                      </h5>
                        ...
                        <Col lg={8}>
                          <div className="ps-lg-4">
                            <div className="d-flex flex-wrap align-items-start gap-3">
                              <h5 className="fs-14 fw-bold">Reviews: </h5>
                            </div>
