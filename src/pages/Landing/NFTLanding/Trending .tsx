                    ...
                    <Card>
                      <CardBody>
                        <Row className="g-1 mb-3">
                          ...
                          <Col lg={6}>
                            <img
                              src="https://img.themesbrand.com/adotar/images/img-5.gif"
                              alt=""
                      ...
                      <CardBody>
                        <Row className="g-1 mb-3">
                          <Col lg={6}>
                            ...
                            />
                            <img
                              src="https://img.themesbrand.com/adotar/images/img-1.gif"
                              alt=""
                              className="img-fluid rounded mt-1"
                            />
                          </Col>
                          <Col lg={6}>
                            <img
                              src="https://img.themesbrand.com/adotar/images/img-4.gif"
                              alt=""
                              className="img-fluid rounded mb-1"
                            />
                            <img
                      ...
                      <CardBody>
                        <Row className="g-1 mb-3">
                          <Col lg={6}>
                            ...
                            />
                            <img
                              src="https://img.themesbrand.com/adotar/images/img-3.gif"
                              alt=""
                              className="img-fluid rounded mt-1"
                            />
                          </Col>
