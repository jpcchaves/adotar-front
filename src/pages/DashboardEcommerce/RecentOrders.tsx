              ...
              <table className="table table-borderless table-centered align-middle table-nowrap mb-0">
                ...
                <tbody>
                  {(recentOrders || []).map((item, key) => (
                    <tr key={key}>
                      <td>
                        <Link to="/apps-ecommerce-order-details" className="fw-medium link-primary">
                          {item.orderId}
                        </Link>
                      </td>
                      <td>
                      ...
                      <td>{item.vendor}</td>
                      <td>
                        <span className={`badge bg-${item.statusClass}-subtle text-${item.statusClass}`}>
                          {item.status}
                        </span>
                      </td>
                      <td>
                        <h5 className="fs-14 fw-medium mb-0">
                          {item.rating}
                          <span className="text-muted fs-13 ms-1">({item.votes} votes)</span>
                        </h5>
                      </td>
                    </tr>
                  ))}
