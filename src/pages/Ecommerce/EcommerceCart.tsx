...
const EcommerceCart = () => {
  document.title = "Shopping Cart | adotar - React Admin & Dashboard Template";
              ...
              <div className="sticky-side-div">
                  ...
                  <CardHeader className="bg-light-subtle border-bottom-dashed">
                    <div className="text-center">
                      <h6 className="mb-2 fs-15">
                        Have a <span className="fw-bold">promo</span> code ?
                      </h6>
                    </div>
                        ...
                        <tbody>
                          ...
                          <tr className="table-active">
                            ...
                            <td className="text-end">
                              <span className="fw-bold" id="cart-total">
                ...
                <UncontrolledAlert color="danger" className="border-dashed">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-2">
                      <h5 className="fs-16 text-danger fw-bold">
                        {" "}
                        Buying for a loved one?
                      </h5>
                      <p className="text-body mb-1">
                        Gift wrap and personalised message on card, <br />
                        Only for <span className="fw-bold">$9.99</span> USD
                      </p>
                      <button
                        type="button"
