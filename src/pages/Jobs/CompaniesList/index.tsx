...
const CompaniesList = () => {
  ...
  const filterData = () => {
    ...
    const filteredData = jobCompanies.filter((item: any) => {
      ...
      const dateMatch =
        date.length === 0 ||
        (new Date(item.since) >= new Date(date[0]) &&
          new Date(item.since) <= new Date(date[1]));
  ...
  document.title = "Companies | adotar - React Admin & Dashboard Template";
              ...
              <Card id="company-overview">
                ...
                <CardBody>
                  ...
                  <p className="text-muted mb-4 overview-companydesc">
                    {info.company_info ||
                      "The IT department of NavLink company ensures that the network of computers within the organization are well-connected and functioning properly. All the other departments within the company rely on them to ensure that their respective functions can go on seamlessly."}
                  </p>
                    ...
                    <Table className="table-borderless mb-4">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className="overview-employee">
                            {info.employee || "10-50"}
                          </td>
                        </tr>
                        <tr>
